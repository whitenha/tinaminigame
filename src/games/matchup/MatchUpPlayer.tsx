...
// ══════════════════════════════════════════════════════════════
export default function MatchUpPlayer({ items: rawItems = [], activity, playerName, onFinish }: any) {
  ...
  const [results, setResults] = useState<any>({});            // { defId: 'correct'|'wrong' }
  ...
  // ── Helpers ────────────────────────────────────────────────
  // @ts-ignore
  const getTermById = (id: any) => shuffledTerms.find(t => t.id === id) || pairs.find(p => p.id === id);
