...
const CustomGiftBox = ({ number, status, isActive }: any) => {
  return (
...
export default function OpenBoxPlayer({ items, activity, playerName }: any) {
  ...
  const [activeBoxIndex, setActiveBoxIndex] = useState<any>(null);
  ...
  const handleBoxClick = (e: any, idx: any) => {
