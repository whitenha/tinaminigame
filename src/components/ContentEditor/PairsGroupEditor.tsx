 ...
 */
export default function PairsGroupEditor({ item, onChange }: any) {
  if (!item) return null;
  ...
  const removePair = (index: any) => {
    ...
    const newPairs = pairs.filter((_: any, i: any) => i !== index);
    onChange({ ...item, pairs: newPairs });
  };
          ...
          <div key={idx} className={styles.pairRow}>
            ...
            <div className={styles.inputGroup}>
              ...
              <textarea
                ...
                value={pair.term || ''}
                onChange={(e) => updatePair(idx, 'term', (e.target as any).value)}
                rows={2}
              />
            </div>
            ...
            <div className={styles.inputGroup}>
              ...
              <textarea
                ...
                onChange={(e) => updatePair(idx, 'definition', (e.target as any).value)}
                rows={2}
              />
            </div>
