 ...
 */
export default function SpellWordEditor({ item, onChange }: any) {
  if (!item) return null;
    ...
    <div className={styles.editor}>
      <div className={styles.mainInput}>
        ...
        <input
          ...
          value={item.term || ''}
          onChange={(e) => updateField('term', (e.target as any).value)}
          autoFocus
        />
      </div>
      ...
      <div className={styles.subInput}>
        ...
        <input
          ...
          onChange={(e) => updateField('definition', (e.target as any).value)}
        />
      </div>
