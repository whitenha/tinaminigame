 ...
 */
export default function TrueFalseEditor({ item, onChange }: any) {
  if (!item) return null;
    ...
    <div className={styles.editor}>
      <div className={styles.statementGroup}>
        ...
        <textarea
          ...
          value={item.question || ''}
          onChange={(e) => updateQuestion((e.target as any).value)}
          rows={3}
          autoFocus
        />
      </div>
        ...
        <div className={styles.optionsList}>
          <div className={styles.optionItem}>
            ...
            <input
              ...
              value={options[0]}
              onChange={(e) => updateOption(0, (e.target as any).value)}
            />
          </div>
          <div className={styles.optionItem}>
            ...
            <input
              ...
              value={options[1]}
              onChange={(e) => updateOption(1, (e.target as any).value)}
            />
          </div>
          <div className={styles.optionItem}>
            <div className={`${styles.optionIndicator} ${styles.indicatorWrong}`}>✗ Sai</div>
            <input
              ...
              value={options[2]}
              onChange={(e) => updateOption(2, (e.target as any).value)}
            />
          </div>
          <div className={styles.optionItem}>
            <div className={`${styles.optionIndicator} ${styles.indicatorWrong}`}>✗ Sai</div>
            <input
              ...
              value={options[3]}
              onChange={(e) => updateOption(3, (e.target as any).value)}
            />
          </div>
        </div>
      </div>
