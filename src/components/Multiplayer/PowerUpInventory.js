 ...
 */
export default function PowerUpInventory({ inventory, onUseItem, activeEffects, itemMultiplier }) {
  ...
  const hasFreezeEffect = activeEffects.some(e => e.effectType === 'freeze_player');
  const hasBlurEffect = activeEffects.some(e => e.effectType === 'blur_screen');
