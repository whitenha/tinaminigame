...
function randomInRange(rng: any, min: any, max: any) {
  return min + rng() * (max - min);
}

function pickFromPool(rng: any, pool: any) {
...
function generatePetals(layerKey: any, count: any, seed: any) {
  // @ts-ignore
