...
export default function MultiplayerGroupSortBoard({ 
  ...
  const [purgedPieceIds, setPurgedPieceIds] = useState<any[]>([]);
  const [lockedPieceIds, setLockedPieceIds] = useState<any[]>([]);
  const [wrongPieceIds, setWrongPieceIds] = useState<any[]>([]);
