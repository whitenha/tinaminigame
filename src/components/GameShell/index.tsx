 ...
 */
export function CountdownScreen({ num, label = 'Sẵn sàng!', emoji = '🎯' }: any) {
  return (
 ...
 */
export function GameTopBar({ counter, playerName, score, streak = 0, extra }: any) {
  return (
 ...
 */
export function TimerBar({ timeLeft, maxTime, showBubble = true }: any) {
 ...
 */
export function TimerBubble({ timeLeft }: any) {
  const isDanger = timeLeft <= 5;
  return (
 ...
 */
export function ResultScreen({ playerName, score, answers = [], items = [], onRetry, title = 'Kết Quả', extraStats }: any) {
...
export function ConfettiOverlay({ active = false }: any) {
