        ...
        <div className={styles.panel}>
          ...
          <div className={styles.sliderRow}>
            ...
            <input 
              ...
              min="0" max="100" 
              value={musicVol} 
              onChange={(e) => setMusicVol(Number((e.target as any).value))}
          ...
          <div className={styles.sliderRow}>
            ...
            <input 
              ...
              min="0" max="100" 
              value={effectVol} 
              onChange={(e) => setEffectVol(Number((e.target as any).value))}
          ...
          <div className={styles.sliderRow}>
            ...
            <input 
              ...
              min="0" max="100" 
              value={voiceVol} 
              onChange={(e) => setVoiceVol(Number((e.target as any).value))}
              onMouseUp={testVoice}
