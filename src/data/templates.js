...
export const CATEGORIES = [
  ...
  { id: 'quiz',     label: 'Trắc nghiệm',  emoji: '❓' },
  { id: 'matching', label: 'Ghép nối',      emoji: '🔗' },
  { id: 'word',     label: 'Từ vựng',       emoji: '🔤' },
  { id: 'sentence', label: 'Câu',           emoji: '✏️' },
  { id: 'card',     label: 'Thẻ',           emoji: '🃏' },
  { id: 'wheel',    label: 'Vòng quay',     emoji: '🎡' },
  { id: 'action',   label: 'Hành động',     emoji: '🏃' },
  { id: 'visual',   label: 'Hình ảnh',      emoji: '📊' },
...
export const TEMPLATES = [
  ...
  {
    id: 32, slug: 'image-quiz',
    name: 'Image Quiz', nameVi: 'Đố hình',
    description: 'Hình ảnh hiện ra từ từ. Bấm chuông khi bạn biết đáp án!',
    howToPlay: 'Hình ảnh được tiết lộ dần. Nhận ra sớm để ghi điểm cao.',
    category: 'quiz', tier: 'pro', color: COLORS.pink,
    badges: ['PRO'], difficulty: 3, playerCount: '1-30',
    engine: {
      contentFormat: 'MCQ', playerType: 'imagequiz', musicType: 'quiz',
      engineType: 'selection', scoringPolicy: 'reveal-bonus',
      hasLeaderboard: true, hasTimer: true, inputMode: 'tap',
      supportedFormats: ['MCQ'],
    },
  },
...
export function filterByTier(tier) {
...
export function getRelatedTemplates(slug, limit = 4) {
 ...
 */
export function getAllPlayerTypes() {
  const set = new Set();
  TEMPLATES.forEach(t => {
